    ...
    >
      ...
      <section className="w-full max-w-3xl bg-white p-8 mb-8 shadow-lg rounded-xl">
        ...
        <p className="text-lg text-gray-600">
          ...
          Our platform is built on a foundation of trust, innovation, and reliability, offering advanced detection tools, real-time threat analysis, and seamless protection against viruses, malware, and cyberattacks. With a user-friendly interface and robust security protocols, we aim to deliver powerful protection that doesn't compromise performance.

Whether you're an individual, a business, or an organization, our mission is to empower you with tools that ensure your digital environment remains safe, private, and uncompromised. At File Analyzer, we’re not just protecting devices—we’re safeguarding your peace of mind.
      ...
      <section className="w-full max-w-3xl p-8 mb-8">
        <h2 className="text-4xl font-bold mb-6 text-center" >Operations</h2>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <section className="w-full max-w-3xl bg-white p-8 mb-8 shadow-lg rounded-xl">
        ...
        <p className="text-lg text-gray-600 mb-4">
          ...
          and potential risks.
          A file scanner works by analyzing files to detect malicious content, viruses, or suspicious patterns. When a file is scanned, the scanner compares its content against a database of known threat signatures (predefined patterns of malicious code) or uses heuristic analysis to identify suspicious behaviors.
        </p>
      </section>
